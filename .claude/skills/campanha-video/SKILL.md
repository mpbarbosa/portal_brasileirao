...
| `docs/medias/<name>-916.mp4` | only for Instagram Reels | 1080×1920 60fps, `VELAS_ASPECT=9:16`. **Not the tall version of the 4:5** — the Reels UI eats ~250px top, ~480px bottom and ~140px of right rail, so it has 8,81 safe units against the feed's 10,0. The chave and the credit live below the safe line on purpose; the post's caption has to repeat them |
...
| `docs/medias/<name>.gif` | yes, **except beside a `-45.mp4` or a `-916.mp4`** | 960×540 15fps, derived from the committed mp4 — plays by itself in a README, an issue, a chat or a Reddit feed that will not open a player |
