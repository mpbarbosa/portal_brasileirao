...
![Página Ao vivo no tema claro, sem jogo a decorrer: a secção Agora não traz nenhum cartão e diz "Nenhuma partida em andamento agora". Abaixo, A seguir lista seis jogos de domingo, 06/09 — Coritiba × Mirassol às 11:00, Cruzeiro × Athletico-PR, Internacional × Santos e Clube do Remo × Flamengo às 16:00, Botafogo × Palmeiras às 18:30 e Corinthians × Chapecoense às 19:30 —, cada um com os escudos dos dois clubes no próprio título, a data, o horário, a contagem regressiva — "Começa em 10h18" no primeiro, "Começa em 15h18" nos três das 16:00, "Começa em 17h48" e "Começa em 18h48" nos dois últimos —, a etiqueta A realizar e as marcas das emissoras, do Premiere sozinho no primeiro às quatro do Botafogo × Palmeiras. A secção Últimos resultados fica abaixo do recorte.](docs/screenshots/ao-vivo-light.png)

![A mesma página Ao vivo no tema escuro, com a mesma secção Agora vazia, a mesma lista A seguir de seis jogos com as mesmas contagens regressivas, e as marcas das emissoras mantendo o fundo claro para continuarem legíveis.](docs/screenshots/ao-vivo-dark.png)
...
![Página de jogos no tema claro: o seletor de rodada na 26ª — a rodada mais antiga que ainda tem jogo por disputar, e por isso a que a página abre — e os jogos dela, com o sábado já decidido e o domingo por vir. Os três de sábado 05/09 trazem placar e a etiqueta Encerrado: Bragantino 2 × 3 Bahia às 16:00, São Paulo 2 × 0 Atlético-MG às 18:30 e Fluminense 1 × 0 Vasco da Gama às 21:00. Abaixo, marcados A realizar, Coritiba × Mirassol às 11:00 de domingo 06/09, Cruzeiro × Athletico-PR, Internacional × Santos e Clube do Remo × Flamengo às 16:00, e Botafogo × Palmeiras às 18:30, com que o enquadramento acaba. Cada linha tem os escudos dos dois clubes no título, a data, o horário e as marcas das emissoras.](docs/screenshots/jogos-light.png)

![A mesma página de jogos no tema escuro, com o mesmo seletor de rodada, os mesmos três placares de sábado marcados Encerrado, os mesmos cinco jogos de domingo por disputar e as mesmas marcas das emissoras sobre fundo claro.](docs/screenshots/jogos-dark.png)
...
![Página da partida Palmeiras 4 x 1 Vasco da Gama no tema claro: a 24ª rodada à esquerda e a etiqueta Encerrado à direita; placar com escudos e, sob o nome de cada clube, uma ligação para o seu artigo na Wikipédia; sob uma linha divisória, quem marcou de cada lado e em que minuto — Lopez aos 46', Vitor Roque de pênalti aos 50', Mauricio aos 55' e Lopez aos 89' pelo Palmeiras, Facundo aos 90+3' pelo Vasco — os quatro nomes do Palmeiras sublinhados, porque abrem o cartão do jogador, e o do Vasco em texto simples, porque o elenco congelado não o resolve; os melhores momentos, duas marcas — a ge e o UOL Esporte — que abrem o vídeo no YouTube, sob a legenda “Melhores momentos no YouTube, por emissora”; a data e a hora; o estádio, com um alfinete ao lado do nome "Nubank Parque", que liga à página do próprio estádio, e a cidade e o estado em texto simples; as emissoras que transmitiram; uma secção Escalações recolhida, que se abre para os dois onzes; e, no pé do enquadramento, a Campanha — com um botão que a troca de linha para barras —, da qual só cabe o gráfico do Palmeiras; a do Vasco da Gama fica abaixo do recorte.](docs/screenshots/partida-554977-light.png)
