...
![Página Ao vivo no tema claro, com três jogos a decorrer: a secção Agora traz um cartão por jogo — cada um com "26ª rodada" no canto, os escudos e nomes dos dois clubes de lado a lado com o placar ao centro, a etiqueta "Bola rolando" com um ponto verde à direita, uma ligação "Ver a partida" e as marcas das emissoras — para Cruzeiro 0 × 0 Athletico-PR, Internacional 0 × 1 Santos e Clube do Remo 0 × 0 Flamengo, os três das 16:00. Sob eles, a nota "Placares atualizados automaticamente enquanto a página estiver aberta", que é o que a página faz sem se recarregar. Abaixo, A seguir lista os três que faltam — Botafogo × Palmeiras às 18:30 e Corinthians × Chapecoense às 19:30, ambos de domingo 06/09, e Vitória × Grêmio às 20:00 de segunda, 07/09 —, cada um com a data, o horário, a contagem regressiva ("Começa em 2h16", "Começa em 3h16" e "Começa em 1 dia", que é a forma que a contagem toma para um jogo a mais de um dia), a etiqueta A realizar e as marcas das emissoras. A secção Últimos resultados fica abaixo do recorte.](docs/screenshots/ao-vivo-light.png)

![A mesma página Ao vivo no tema escuro, com os mesmos três cartões em Agora e os mesmos placares, a mesma nota sobre a atualização automática, a mesma lista A seguir de três jogos com as mesmas contagens regressivas, e as marcas das emissoras mantendo o fundo claro para continuarem legíveis.](docs/screenshots/ao-vivo-dark.png)
...
![Página de jogos no tema claro: o seletor de rodada na 26ª — a rodada mais antiga que ainda tem jogo por disputar, e por isso a que a página abre — e os jogos dela nos três estados que a rodada tem ao mesmo tempo. Quatro trazem placar e a etiqueta Encerrado: Bragantino 2 × 3 Bahia às 16:00 de sábado 05/09, São Paulo 2 × 0 Atlético-MG às 18:30, Fluminense 1 × 0 Vasco da Gama às 21:00 e Coritiba 1 × 2 Mirassol às 11:00 de domingo 06/09. Três trazem placar e a etiqueta Ao vivo, os três das 16:00 de domingo: Cruzeiro 0 × 0 Athletico-PR, Internacional 0 × 1 Santos e Clube do Remo 0 × 0 Flamengo. Os dois últimos, marcados A realizar, ainda não têm placar: Botafogo × Palmeiras às 18:30 e Corinthians × Chapecoense às 19:30, com que o enquadramento acaba. Cada linha tem os escudos dos dois clubes no título, a data, o horário e as marcas das emissoras.](docs/screenshots/jogos-light.png)

![A mesma página de jogos no tema escuro, com o mesmo seletor de rodada, os mesmos quatro placares Encerrado, os mesmos três jogos Ao vivo com os seus placares, os mesmos dois por disputar e as mesmas marcas das emissoras sobre fundo claro.](docs/screenshots/jogos-dark.png)
...
![Página da partida Palmeiras 4 x 1 Vasco da Gama no tema claro: a 24ª rodada à esquerda e a etiqueta Encerrado à direita; placar com escudos e, sob o nome de cada clube, uma ligação para o seu artigo na Wikipédia; sob uma linha divisória, quem marcou de cada lado e em que minuto — Lopez aos 46', Vitor Roque de pênalti aos 50', Mauricio aos 55' e Lopez aos 89' pelo Palmeiras, Facundo aos 90+3' pelo Vasco — os quatro nomes do Palmeiras sublinhados, porque abrem o cartão do jogador, e o do Vasco em texto simples, porque o elenco congelado não o resolve; os melhores momentos, duas marcas — a ge e o UOL Esporte — que abrem o vídeo no YouTube, sob a legenda “Melhores momentos no YouTube, por emissora”; a data e a hora; o estádio, com um alfinete ao lado do nome "Nubank Parque", que liga à página do próprio estádio, e a cidade e o estado em texto simples; as emissoras que transmitiram; e, no pé do enquadramento, a secção Escalações recolhida — uma seta e a palavra, que se abre para os dois onzes e para os bancos. A Campanha dos dois clubes fica abaixo do recorte.](docs/screenshots/partida-554977-light.png)

![A mesma página da partida no tema escuro, com o mesmo placar, as mesmas ligações para a Wikipédia sob cada clube, os mesmos marcadores e minutos dos dois lados, com os mesmos quatro nomes sublinhados e o quinto não, os mesmos melhores momentos, o mesmo estádio com o seu alfinete, as mesmas emissoras — com as marcas mantendo o fundo claro —, e a mesma secção Escalações recolhida a fechar o enquadramento.](docs/screenshots/partida-554977-dark.png)
