...
![Classificação do Campeonato Brasileiro Série A no tema claro: no alto, à direita, o botão Entrar, ao lado do que alterna entre o tema claro e o escuro. Numa linha própria sob ele, as secções Classificação, Ao vivo, Jogos, Artilharia e Jogadores, a atual sublinhada. Abaixo, os 20 clubes com escudo, pontos, o gráfico da campanha, jogos, vitórias, empates, derrotas, saldo de gols e o aproveitamento em percentagem. Os quatro primeiros trazem uma faixa verde (G4) e os quatro últimos uma faixa vermelha (Z4), e logo abaixo da tabela uma legenda diz o que cada faixa significa: G4 Libertadores, as quatro primeiras posições, e Z4 Rebaixamento, as quatro últimas. Ao pé da página, o rodapé diz que o projeto é independente e sem vínculo com a CBF ou com os clubes, e traz a saúde do serviço: estado, fonte dos dados, versão, quando foi compilado e desde quando está no ar.](docs/screenshots/classificacao-light.png)
