...
<img src="docs/screenshots/clube-palmeiras-mobile-light.png" alt="A página do clube Palmeiras num telemóvel no tema claro: o mesmo cartão do escudo emoldurado, a legenda “PAL · SP”, o nome, o nome “SE Palmeiras”, a etiqueta “G4 · Libertadores”, o técnico, o endereço da sede com o seu alfinete e a fila de links, agora empilhada em vez de correr numa linha só, com o X @Palmeiras, o YouTube @Palmeiras e o Facebook @Palmeiras cada um numa linha própria logo abaixo do Instagram; à direita do cartão, o botão Seguir; abaixo dele, as cápsulas de Posição, Pontos e Jogos numa linha, Saldo e Aproveitamento na seguinte e Média sozinha numa terceira; e a faixa Painel do clube, onde o enquadramento acaba — as linhas a mais do X e do Facebook empurraram o título Últimos resultados para debaixo da barra de navegação — a barra de navegação fixa no rodapé cobre o resto da tela" width="300"> <img src="docs/screenshots/clube-palmeiras-mobile-dark.png" alt="A mesma página do clube Palmeiras num telemóvel no tema escuro, com o mesmo cartão, o mesmo X, o mesmo YouTube e o mesmo Facebook na fila de links, as mesmas cápsulas em três linhas e a mesma faixa do Painel do clube, com o enquadramento a acabar no mesmo lugar" width="300">
