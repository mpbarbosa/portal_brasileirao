...
![Página Ao vivo no tema claro, sem nenhum jogo em andamento: a secção Agora diz “Nenhuma partida em andamento agora.” — o estado normal fora das tardes de rodada, e o que a página mostra quando não há bola rolando. Depois, A seguir lista seis jogos, cada um com o nome de um clube, os dois escudos encostados ao × no meio e o nome do outro, a data, o horário, a contagem regressiva e a etiqueta A realizar: Bahia × Clube do Remo, segunda 14/09 às 20:00, Começa em 18h43 — a única contagem em horas, por ser a de hoje; Botafogo × Grêmio, quarta 16/09 às 19:30, Começa em 2 dias; Atlético-MG × Chapecoense, Mirassol × Botafogo e Clube do Remo × Santos, de sábado 19/09 às 16:00, 17:00 e 18:30, Começa em 5 dias; e Vasco da Gama × Coritiba, também sábado 19/09 às 20:30, Começa em 5 dias. Cinco dos seis carregam marca de emissora — o Premiere FC em quatro, com Record, YouTube e CazéTV a acompanhá-lo em Mirassol × Botafogo e o prime video sozinho em Vasco da Gama × Coritiba. Abaixo, Últimos resultados abre com Flamengo 2 × 1 Corinthians, domingo 13/09 às 17:30, Encerrado, com as marcas do ge, da tv globo e do Premiere FC, onde o enquadramento acaba](docs/screenshots/ao-vivo-light.png)

![A mesma página Ao vivo no tema escuro, com o mesmo aviso de que não há partida em andamento, a mesma lista A seguir de seis jogos com as mesmas contagens regressivas e as mesmas marcas de emissora, e o mesmo Flamengo 2 × 1 Corinthians a abrir os Últimos resultados, terminando no mesmo ponto](docs/screenshots/ao-vivo-dark.png)
...
<img src="docs/screenshots/clube-palmeiras-mobile-light.png" alt="A página do clube Palmeiras num telemóvel no tema claro: o mesmo cartão do escudo emoldurado, a legenda “PAL · SP”, o nome, o nome “SE Palmeiras”, a etiqueta “G4 · Libertadores”, o técnico, o endereço da sede com o seu alfinete e a fila de links, agora empilhada em vez de correr numa linha só; à direita do cartão, o botão Seguir; abaixo dele, as cápsulas de Posição, Pontos e Jogos numa linha, Saldo e Aproveitamento na seguinte e Média sozinha numa terceira; a faixa Painel do clube e o título Últimos resultados, onde o enquadramento acaba — a barra de navegação fixa no rodapé cobre o resto da tela" width="300"> <img src="docs/screenshots/clube-palmeiras-mobile-dark.png" alt="A mesma página do clube Palmeiras num telemóvel no tema escuro, com o mesmo cartão, as mesmas cápsulas em três linhas, a mesma faixa do Painel do clube e o mesmo título Últimos resultados, com o enquadramento a acabar no mesmo lugar" width="300">
...
![Página de jogos no tema claro: o seletor de rodada na 27ª — a rodada mais antiga que ainda tem jogo por disputar, e por isso a que a página abre — com a rodada já quase toda jogada no enquadramento. Nove jogos, todos com placar e a etiqueta Encerrado: Coritiba 3 × 3 Athletico-PR às 21:00 de sexta 11/09; no sábado 12/09, Atlético-MG 3 × 1 Fluminense e Grêmio 1 × 2 Vasco da Gama às 16:00, Chapecoense 1 × 2 Internacional às 17:00, Palmeiras 2 × 0 São Paulo às 18:30, Botafogo 1 × 1 Bragantino às 20:30 e Santos 2 × 1 Cruzeiro às 21:00; e no domingo 13/09, Mirassol 2 × 2 Vitória às 16:00 e Flamengo 2 × 1 Corinthians às 17:30, com que o enquadramento acaba — Bahia × Clube do Remo, que fecha a rodada na segunda, fica abaixo do recorte. Cada linha traz no título o nome de um clube, os dois escudos encostados ao placar e o nome do outro, a data e o horário, e as marcas das emissoras que transmitiram](docs/screenshots/jogos-light.png)

![A mesma página de jogos no tema escuro, com o mesmo seletor de rodada, os mesmos nove jogos encerrados com os mesmos placares e as mesmas marcas das emissoras sobre fundo claro](docs/screenshots/jogos-dark.png)
