...
![Página Ao vivo no tema claro, sem jogo a decorrer: a secção Agora não traz nenhum cartão e diz "Nenhuma partida em andamento agora". Abaixo, A seguir lista seis jogos por vir — Bragantino × Bahia, São Paulo × Atlético-MG, Fluminense × Vasco da Gama, Coritiba × Mirassol, Cruzeiro × Athletico-PR e Internacional × Santos — cada um com os escudos dos dois clubes no próprio título, a data, o horário, a contagem regressiva — "Começa em 1 dia" nos três de sábado e "Começa em 2 dias" nos três de domingo —, a etiqueta A realizar e as marcas das emissoras; e Últimos resultados abre com Flamengo 2 × 0 Mirassol, de quarta-feira, marcado Encerrado.](docs/screenshots/ao-vivo-light.png)
...
![Página do clube Palmeiras no tema claro: escudo, o técnico Abel Ferreira, o endereço da sede — com um alfinete, que abre o endereço no mapa —, site oficial, perfil no Instagram, hino do clube e artigo na Wikipédia; à direita, o botão Seguir, que marca o clube como o time do leitor; os números da temporada (1º lugar, 52 pontos, 25 jogos, saldo +24 e 69% de aproveitamento); logo abaixo, uma faixa Painel do clube, “A campanha inteira: onde cada rodada terminou e o que houve dentro dela”, que leva a essa página — a própria campanha não é desenhada aqui, mudou-se para o painel; os últimos cinco resultados, o próximo jogo — Botafogo × Palmeiras, com o escudo de cada clube, domingo 06/09 às 18:30, marcado como A realizar e com as marcas do Premiere, da Record, do YouTube e da CazéTV —, os artilheiros do clube, José Manuel López com 8 gols e Mauricio com 7, e os Vídeos do clube, com a miniatura de “Palmeiras × Flamengo: a campanha rodada a rodada do Brasileirão 2026 (até a 25ª)”, de Marcelo Barbosa, que abre no YouTube. Os Jogos disputados ficam abaixo do recorte.](docs/screenshots/clube-palmeiras-light.png)

![A mesma página do clube Palmeiras no tema escuro: os mesmos escudo, técnico, endereço da sede com o seu alfinete, quatro links, o mesmo botão Seguir e os mesmos números da temporada; a mesma faixa do Painel do clube, igualmente sem gráfico da campanha acima dela; os mesmos últimos resultados, o mesmo próximo jogo, os mesmos artilheiros e o mesmo vídeo do clube, com as marcas das emissoras mantendo o fundo claro para continuarem legíveis.](docs/screenshots/clube-palmeiras-dark.png)

![Página de jogos no tema claro: o seletor de rodada na 26ª — a rodada mais antiga que ainda tem jogo por disputar, e por isso a que a página abre — e os jogos dela, todos os que cabem no enquadramento marcados A realizar: Bragantino × Bahia, São Paulo × Atlético-MG e Fluminense × Vasco da Gama no sábado 05/09, às 16:00, 18:30 e 21:00, e Coritiba × Mirassol, Cruzeiro × Athletico-PR, Internacional × Santos, Clube do Remo × Flamengo e Botafogo × Palmeiras no domingo 06/09, das 11:00 às 18:30. Cada um traz os escudos dos dois clubes no próprio título, a data, o horário e as marcas das emissoras que o vão transmitir — o Premiere em todos, com a tvglobo, o SporTV, a ge, a Record, o YouTube e a CazéTV somando-se em alguns. Nenhum tem placar, porque nenhum foi jogado ainda.](docs/screenshots/jogos-light.png)

![A mesma página de jogos no tema escuro, com o mesmo seletor de rodada, os mesmos jogos por disputar e as mesmas marcas das emissoras sobre fundo claro.](docs/screenshots/jogos-dark.png)
...
![Página da partida Palmeiras 4 x 1 Vasco da Gama no tema claro: a 24ª rodada à esquerda e a etiqueta Encerrado à direita; placar com escudos e, sob o nome de cada clube, uma ligação para o seu artigo na Wikipédia; sob uma linha divisória, quem marcou de cada lado e em que minuto — Lopez aos 46', Vitor Roque de pênalti aos 50', Mauricio aos 55' e Lopez aos 89' pelo Palmeiras, Facundo aos 90+3' pelo Vasco; os melhores momentos, duas marcas — a ge e o UOL Esporte — que abrem o vídeo no YouTube, sob a legenda “Melhores momentos no YouTube, por emissora”; a data e a hora; o estádio, com um alfinete ao lado do nome "Nubank Parque", que liga à página do próprio estádio, e a cidade e o estado em texto simples; as emissoras que transmitiram; uma secção Escalações recolhida, que se abre para os dois onzes; e, no pé do enquadramento, a Campanha — com um botão que a troca de linha para barras —, da qual só cabe o gráfico do Palmeiras; a do Vasco da Gama fica abaixo do recorte.](docs/screenshots/partida-554977-light.png)

![A mesma página da partida no tema escuro, com o mesmo placar, as mesmas ligações para a Wikipédia sob cada clube, os mesmos marcadores e minutos dos dois lados, os mesmos melhores momentos, o mesmo estádio com o seu alfinete, as mesmas emissoras — com as marcas mantendo o fundo claro —, a mesma secção Escalações recolhida e, no pé, o mesmo único gráfico da Campanha.](docs/screenshots/partida-554977-dark.png)
...
![Página da partida Botafogo 1 x 1 Fluminense no tema claro: a 22ª rodada à esquerda e a etiqueta Encerrado à direita; o placar com os escudos dos dois clubes e, sob o nome de cada um, uma ligação para o seu artigo na Wikipédia; sob uma linha divisória, quem marcou de cada lado e quando — Alex Telles, de falta, aos 43' pelo Botafogo, e Ignacio aos 58' pelo Fluminense; os melhores momentos, três marcas — a ge, a CazéTV e o UOL Esporte — que abrem o vídeo no YouTube, sob a legenda “Melhores momentos no YouTube, por emissora”; a data e a hora do jogo; o estádio, com um alfinete ao lado do nome "Nilton Santos", que liga à página do próprio estádio, e a cidade e o estado; a linha do árbitro, que nomeia Bruno Arleu de Araujo; e as emissoras que transmitiram. Abaixo, a secção Escalações, fechada — é preciso abri-la para ver os onze e o banco de cada lado. No pé do enquadramento começa a Campanha, da qual só cabe o gráfico do Botafogo, sem os rótulos das rodadas; a do Fluminense fica abaixo do recorte.](docs/screenshots/partida-554951-light.png)

![A mesma página da partida no tema escuro, com o mesmo placar e escudos, as mesmas ligações para a Wikipédia sob cada clube, os mesmos marcadores com os seus minutos dos dois lados, os mesmos melhores momentos, a mesma linha do árbitro, o mesmo estádio com o seu alfinete, as mesmas emissoras — com as marcas mantendo o fundo claro — e a mesma secção Escalações fechada sobre o mesmo único gráfico da campanha.](docs/screenshots/partida-554951-dark.png)
