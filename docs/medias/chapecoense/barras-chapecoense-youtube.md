...
```
A corrida da Chapecoense no Brasileirão 2026: 27 rodadas contra os outros 19
```
...
| 3 | `A Chapecoense contra a divisão: o Brasileirão 2026 em 27 rodadas e 22 segundos` | 78 | o formato e a duração; ajuda a retenção |
| 4 | `3 vitórias em 26 jogos: a Chapecoense contra a divisão no Brasileirão 2026` | 74 | o número duro; só se o canal aceitar o tom |
...
```
A corrida da Chapecoense no Brasileirão em 22s #Shorts
```
...
• Chapecoense — 20º, 17 pontos em 26 jogos (3 vitórias, 8 empates, 15 derrotas)
• Na lanterna desde a 12ª rodada, 16 rodadas seguidas
• 21 jogos sem vencer, da 2ª à 23ª rodada
• Duas vitórias nas últimas quatro rodadas, na 24ª e na 26ª: de 11 para 17 pontos
• Clube do Remo — 19º, 23 pontos, com um jogo a mais
• Grêmio — 16º e primeiro fora do Z4, 28 pontos
...
Os filetes marcam o G4 e o Z4. Nem todos os clubes têm o mesmo número de jogos neste recorte, e por isso a linha do fecho diz sobre quantos jogos a Chapecoense chegou aos 17 — e que o Remo, logo acima, tem um jogo a mais.
...
| `barras-chapecoense-miniatura-17-pontos.png` | capa alternativa | a história: o clube, os pontos e a distância para o 19º |

**A capa alternativa se chama `17-pontos` e não `57-pontos` como a do Flamengo**:
