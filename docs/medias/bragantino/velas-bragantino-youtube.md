...
> **Os números aqui saem de `scripts/manim/velas-bragantino.json`, rodada 26,
> snapshot de 2026-09-07** — 9º com 35 pts, 10V 5E 10D, e a oscilação entre
...
> entre o 1º e o 14º e o painel diz 1º e 16º.
>
...
```
Bragantino liderou na 2ª e fechou em 9º: a campanha em velas até a 26ª
```
...
|---|---|---|---|
| 2 | `Bragantino em velas: 35 pontos, 10V 5E 10D \| Brasileirão 2026` | 61 | o número duro |
...
• Bragantino — 9º, 35 pts em 25 jogos
• 10V · 5E · 10D — 31 gols pró, 28 contra, saldo +3
• 47% de aproveitamento · oscilou entre o 1º e o 16º
...
São 10 derrotas em 25 jogos, e a maior invencibilidade é de 5 rodadas. A vela do início e a do fim contam histórias diferentes, que é exatamente o que este desenho existe para mostrar.
...
#Brasileirao #SerieA #Bragantino #Manim #DataViz #Futebol #Python #Candlestick
```
...
```
A campanha do Bragantino em velas: o corpo vai da posição de abertura à de fechamento da rodada, o pavio mostra até onde o clube subiu e desceu dentro dela, e a barra de baixo são os pontos. Liderou na 2ª rodada e fechou o recorte em 9º. Dados até a 26ª: 35 pts, 10V 5E 10D, saldo +3.
...
```
brasileirão, brasileirao 2026, campeonato brasileiro, série a, serie a, bragantino, massa bruta, braga, red bull bragantino, rb bragantino, campanha do bragantino, campanha rodada a rodada, candlestick, gráfico de velas, futebol brasileiro, visualização de dados, dataviz, manim, python, portal brasileirão, rodada 26
```
